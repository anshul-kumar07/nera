...
function PoliciesContent() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto py-3 sm:py-5 px-3 sm:px-6 lg:px-8 space-y-6 font-sans select-none">
      ...
      <header className="bg-white border-2 border-slate-200 py-5 sm:py-6 px-5 sm:px-8 rounded-2xl shadow-sm space-y-4 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-100 pb-4">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <button
              ...
              type="button"
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-slate-700 bg-slate-50 border border-slate-300 rounded-lg shadow-xs hover:bg-slate-100 hover:text-slate-900 transition cursor-pointer"
            >
      ...
      <div className="rounded-xl bg-amber-50/80 border border-amber-300/80 p-3.5 text-amber-950 text-xs flex items-start gap-3 shadow-xs">
        <Globe2 className="w-4 h-4 text-amber-700 shrink-0 mt-0.5" />
        <div className="space-y-0.5">
          <p className="font-bold text-amber-950">Official 22 Scheduled Language Gazette Notice (Digital India Bhashini)</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <aside className="lg:col-span-4 sticky top-14 space-y-4">
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-xs p-3.5 space-y-2">
          ...
          <div className="bg-gradient-to-br from-slate-50 to-blue-50/40 rounded-xl border-2 border-slate-200 p-4 space-y-2.5 text-xs text-slate-700 shadow-xs">
        ...
        <main className="lg:col-span-8 bg-white rounded-xl border-2 border-slate-200 p-5 sm:p-8 shadow-xs space-y-6">
            ...
            <div className="space-y-6">
              {filteredSections.map((sec, idx) => (
                <section key={idx} id={`clause-${idx + 1}`} className="space-y-3 pt-2 scroll-mt-20">
                  <h3 className="text-sm sm:text-base font-black text-[#213d77] flex items-center gap-2 border-l-4 border-[#213d77] pl-3 py-1 bg-slate-50 rounded-r-lg">
                  ...
                  <div className="space-y-2.5 text-xs sm:text-sm text-slate-700 pl-3 leading-relaxed">
                    {sec.content.map((p, pIdx) => {
                      if (p.startsWith('•')) {
                        ...
                        return (
                          <div key={pIdx} className="flex items-start gap-2.5 ml-1 py-1 px-2.5 rounded-lg bg-slate-50/80 border border-slate-200/70">
